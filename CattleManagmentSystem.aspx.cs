...
{
    public partial class CattleManagmentSystem : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            hypEditUser.Visible = true;
            hypCattleInfo.Visible = true;
            hypCattleSearch.Visible = true;
            if (loginType == "Buyer")
            {
                hypAddUser.Visible = false;
                hypEditUser.Visible = true;
                hypCattleInfo.Visible = false;
                hypCattleSearch.Visible = true;
            }
